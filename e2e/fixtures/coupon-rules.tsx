...
apiClient.get = async path => {
  ...
  if (path.includes('type=all')) return [{id:'coupon',organization_id:'org',campaign_id:'campaign',customer_id:'customer',uses_remaining:1,status:'active',created_at:'2026-09-01',updated_at:'2026-09-01',coupon_campaigns:{id:'campaign',name:'25%クーポン',discount_type:'percentage',discount_amount:25,max_uses_per_customer:1}}] as never
