...
createRoot(document.getElementById('root')!).render(<QueryClientProvider client={new QueryClient()}><main style={{ maxWidth: 680, padding: 24, margin: 'auto' }}><h1>募集・締切</h1><BookingCutoffSection masterId="55000000-0000-0000-0000-000000000001" /><BookingDeadlineTab eventId="33000000-0000-0000-0000-000000000001" /></main></QueryClientProvider>)
