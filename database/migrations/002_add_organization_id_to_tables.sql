...
UPDATE stores SET organization_id = 'a0000000-0000-0000-0000-000000000001' WHERE organization_id IS NULL;
...
UPDATE staff SET organization_id = 'a0000000-0000-0000-0000-000000000001' WHERE organization_id IS NULL;
...
UPDATE scenarios SET organization_id = 'a0000000-0000-0000-0000-000000000001' WHERE organization_id IS NULL AND (scenario_type IS NULL OR scenario_type != 'managed');
...
UPDATE schedule_events SET organization_id = 'a0000000-0000-0000-0000-000000000001' WHERE organization_id IS NULL;
...
UPDATE performance_kits SET organization_id = 'a0000000-0000-0000-0000-000000000001' WHERE organization_id IS NULL;
...
UPDATE shift_submissions SET organization_id = 'a0000000-0000-0000-0000-000000000001' WHERE organization_id IS NULL;
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'shift_notifications') THEN
    ...
    UPDATE shift_notifications SET organization_id = 'a0000000-0000-0000-0000-000000000001' WHERE organization_id IS NULL;
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'shift_button_states') THEN
    ...
    UPDATE shift_button_states SET organization_id = 'a0000000-0000-0000-0000-000000000001' WHERE organization_id IS NULL;
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'private_booking_requests') THEN
    ...
    UPDATE private_booking_requests SET organization_id = 'a0000000-0000-0000-0000-000000000001' WHERE organization_id IS NULL;
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'miscellaneous_transactions') THEN
    ...
    UPDATE miscellaneous_transactions SET organization_id = 'a0000000-0000-0000-0000-000000000001' WHERE organization_id IS NULL;
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'gm_availability_responses') THEN
    ...
    UPDATE gm_availability_responses SET organization_id = 'a0000000-0000-0000-0000-000000000001' WHERE organization_id IS NULL;
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'global_settings') THEN
    ...
    UPDATE global_settings SET organization_id = 'a0000000-0000-0000-0000-000000000001' WHERE organization_id IS NULL;
