...
const EVENT_FIELDS = 'id, date, store_id, scenario, scenario_master_id, gms, gm_roles, category, is_cancelled, stores:store_id(name), scenario_masters:scenario_master_id(title, official_duration)'
