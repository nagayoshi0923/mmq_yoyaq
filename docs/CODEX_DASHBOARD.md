...
|---|---|---|---|
| `019f779d-7170-7752-a846-37c593cf3ec8` | `/Users/mai/mmq_yoyaq-1` | `4371ba19225351832b656cc2c851f3d8047bd2f1` | 2026-07-19 10:48 JST |
...
|---|---|---|---|---|---|---|---|---|
| YOYAQ-001 | キャンセルポリシー共通基盤と予約時スナップショット | REPORT | HIGH-RISK | N/A | なし | `019f77fc-8eb6-77a0-b8ba-033a4e9e614a` / `019f7810-79a7-7b51-9f3b-7c35f2b3cd38`検収中 | `e5e4d13ee6c67fc21c737392cb26034715eda6db` | - |
...
- **status/lane:** REPORT / HIGH-RISK（migration、予約金額、日付・締切、既存予約互換）
...
- **review:** task `019f7810-79a7-7b51-9f3b-7c35f2b3cd38`、worktree `/Users/mai/.codex/worktrees/b871/mmq_yoyaq-1`、exact commit detached HEAD / clean、検収中。
- **integration:** 未着手
