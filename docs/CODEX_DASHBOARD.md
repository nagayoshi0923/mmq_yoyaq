...
| YOYAQ-004 | 募集停止枠の貸切申請・承認を一貫して拒否 | REWORK | HIGH-RISK | PO visual OK | なし（YOYAQ-003と非重複で並行可、staging統合は直列） | worker `019f8e6f-2935-7143-b7b2-a03841f62e9f` / review `019f91f3-983e-7723-a528-ace3c1ff196c` REWORK | `643ff96fb010171e919e6c893c3477b2e331e8ef` | 認可・tenant・migration互換3件を同workerで修正中。DB/staging/main未変更 |
...
- **status/lane:** REPORT / HIGH-RISK（重大3件を同workerの追撃commitで修正し、fresh再検収中）
...
- **review:** 初回reviewer `019f91f3-983e-7723-a528-ace3c1ff196c` はtarget `643ff96f...`をREWORK。fresh rereviewer `019f921a-093b-7ae3-a037-63f299ea6c4f`、worktree `/Users/mai/.codex/worktrees/8fbe/mmq_yoyaq-1`、target `a45b989e042e3be0597c21f28160e01ccd1b3377`で重大3点とREWORK delta 4ファイルを再検収中。
- **integration:** 未着手
