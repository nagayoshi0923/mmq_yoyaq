...
| YOYAQ-004 | 募集停止枠の貸切申請・承認を一貫して拒否 | RELEASE_READY | HIGH-RISK | PO visual OK | なし（YOYAQ-003と非重複で並行可、staging統合は直列） | worker `019f8e6f-2935-7143-b7b2-a03841f62e9f` / fresh review `019f921a-093b-7ae3-a037-63f299ea6c4f` DONE | `a45b989e042e3be0597c21f28160e01ccd1b3377` | staging DB/frontend DONE、prod DB先行適用済み。main ff待ち |
...
- **status/lane:** RELEASE_READY / HIGH-RISK（PO visual OK・fresh独立再検収DONE・staging DB/frontend DONE・production DB先行適用/確認済み。main fast-forward待ち）
