-- =============================================================================
-- 20260315010000: 確定済み予約の再承認を許可
-- =============================================================================
--
-- 背景:
-- - 確定済み予約の日程・店舗・GMを変更したいケースがある
-- - 現状のRPCはpending/gm_confirmedのみ許可しているため変更できない
--
-- 修正内容:
-- - confirmedステータスも許可
-- - 既存のschedule_eventを削除またはキャンセルしてから新規作成
--
-- =============================================================================
...
'貸切予約承認をアトミックに実行。confirmed状態の再承認（日程変更）にも対応。';
