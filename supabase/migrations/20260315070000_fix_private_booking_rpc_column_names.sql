-- =============================================================================
-- 20260315070000: create_private_booking_request の organization_scenarios カラム名修正
-- =============================================================================
-- 問題: os.title, os.duration, os.participation_fee を参照していたが、
--       organization_scenarios には title カラムがない（override_title がある）
-- 修正: 正しいカラム名に修正
-- =============================================================================
...
BEGIN
  ...
  -- organization_scenarios には override_title があり、title は scenario_masters にある
  SELECT 
...
-- 関数にコメントを追加（フルシグネチャ指定）
COMMENT ON FUNCTION create_private_booking_request(UUID, UUID, TEXT, TEXT, TEXT, INTEGER, JSONB, TEXT, TEXT, UUID) IS '貸切予約リクエストを作成するRPC関数（organization_scenarios.override_title 対応版）';
