-- =============================================================================
-- 20260314130000: approve_private_booking から confirmed_at カラム参照を削除
-- =============================================================================
--
-- 背景:
-- - reservations テーブルに confirmed_at カラムが存在しない
-- - 前回のマイグレーションで event_datetime は削除したが confirmed_at が残っていた
--
-- =============================================================================
