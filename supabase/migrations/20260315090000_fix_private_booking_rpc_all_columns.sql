-- =============================================================================
-- 20260315090000: create_private_booking_request の全カラム参照を修正
-- =============================================================================
-- 問題: scenario_masters には title, official_duration しかなく、
--       participation_fee は organization_scenarios にのみ存在する
-- 修正: フォールバック時も scenarios_v2 ビューまたは organization_scenarios を使用
-- =============================================================================
...
BEGIN
  ...
  -- カラム名の対応:
  --   organization_scenarios: override_title, duration, participation_fee
  --   scenario_masters: title, official_duration（participation_feeはない）
  SELECT 
