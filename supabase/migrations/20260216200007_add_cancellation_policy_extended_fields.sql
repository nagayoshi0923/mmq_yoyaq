-- キャンセルポリシー拡張フィールドを追加
-- 主催者都合キャンセル、中止判定、予約変更、返金方法などの設定
...
-- コメント追加
COMMENT ON COLUMN public.reservation_settings.organizer_cancel_reasons IS '主催者都合キャンセル理由の配列';
COMMENT ON COLUMN public.reservation_settings.organizer_cancel_refund_note IS '主催者都合キャンセル時の返金説明';
