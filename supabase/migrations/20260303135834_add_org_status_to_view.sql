-- organization_scenarios_with_master ビューに org_status カラムを追加
-- フロントエンドが org_status を参照しているため
-- 作成日: 2026-03-03
...
SELECT
  ...
  os.org_status,  -- フロントエンドが直接参照するため追加
...
COMMENT ON VIEW public.organization_scenarios_with_master IS 
  '組織シナリオとマスタを結合したビュー。Scenario型と互換性あり（org_status追加）';
