-- =============================================================================
-- 20260313120000: create_private_booking_request RPC に reservation_source を追加
-- =============================================================================
-- 問題: 予約作成時に reservation_source が設定されていないため、
--       マイページの「日程調整中の貸切申込み」セクションに表示されない
-- 修正: reservation_source = 'web_private' を設定
-- =============================================================================
...
'貸切予約リクエストを作成。reservation_source を web_private に設定してマイページに表示されるようにする。';

-- 通知
DO $$
BEGIN
  RAISE NOTICE 'create_private_booking_request に reservation_source = web_private を追加しました';
END $$;
