-- =============================================================================
-- 20260313100000: create_private_booking_request RPC の GM カラム参照を修正
-- =============================================================================
-- 問題: ssa.can_gm が存在しない
-- 修正: can_main_gm または can_sub_gm を使用
-- =============================================================================
...
BEGIN
  ...
  -- can_main_gm または can_sub_gm が true のスタッフを取得
  FOR v_gm_id IN
    SELECT ssa.staff_id
...
DO $$
BEGIN
  RAISE NOTICE 'create_private_booking_request RPC の GM カラム参照を修正しました';
END $$;
