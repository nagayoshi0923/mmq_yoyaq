-- approve_private_booking: pending_gm / pending_store ステータスも承認可能にする
-- UI側は pending, pending_gm, gm_confirmed, pending_store を表示しているが、
...
BEGIN
  ...
  WHERE id = p_reservation_id
    AND status IN ('pending', 'pending_gm', 'gm_confirmed', 'pending_store', 'confirmed')
  FOR UPDATE;
