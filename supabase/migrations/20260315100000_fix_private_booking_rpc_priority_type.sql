-- =============================================================================
-- 20260315100000: create_private_booking_request の priority カラム型修正
-- =============================================================================
-- 問題: priority カラムは INTEGER なのに 'normal' という文字列を入れていた
-- 修正: priority = 0 に修正
-- =============================================================================
...
BEGIN
  ...
  INSERT INTO reservations (
    ...
    0,  -- priority: INTEGER (0=通常)
    'private_booking',  -- reservation_type: TEXT
    'web_private',  -- reservation_source: TEXT
    p_private_group_id
  )
