ALTER TABLE public.performance_recruitment_notices ADD COLUMN withdrawal_sequence integer NOT NULL DEFAULT 0;
ALTER TABLE public.performance_recruitment_notices DROP CONSTRAINT performance_recruitment_notices_cycle_unique;
ALTER TABLE public.performance_recruitment_notices ADD CONSTRAINT performance_recruitment_notices_cycle_unique UNIQUE(schedule_event_id,reservation_id,kind,cycle,withdrawal_sequence);
