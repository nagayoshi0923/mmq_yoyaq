...
CREATE TABLE organization_scenarios (id uuid PRIMARY KEY, organization_id uuid, scenario_master_id uuid, override_player_count_min integer, override_player_count_max integer);
