    ...
    <div className="space-y-2 max-h-96 overflow-y-auto">
      {events.map((event) => {
        ...
        return (
          ...
          >
            <div className="flex items-center gap-2 sm:gap-2.5 p-2 sm:p-2.5 touch-manipulation min-h-[56px] sm:min-h-[60px]">
              {/* 左側：日付と店舗情報 */}
              <div className="flex items-start gap-1.5 sm:gap-2 flex-1 min-w-0">
                {/* 日付 */}
                <div className="font-semibold text-sm sm:text-base whitespace-nowrap min-w-[45px] text-center flex-shrink-0">
                  <div>{month}/{day}</div>
              ...
              <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
                {event.available_seats === 0 ? (
                  <Badge variant="outline" className="bg-gray-100 text-gray-800 border-gray-300 text-xs sm:text-sm px-1.5 sm:px-2 py-1 whitespace-nowrap">
                    満席
                  </Badge>
                ) : (
              ...
              <Button
                ...
                className={`flex-shrink-0 min-w-[45px] whitespace-nowrap text-xs sm:text-sm h-8 sm:h-9 px-2 touch-manipulation ${
