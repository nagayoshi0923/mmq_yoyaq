...
export function ScenarioDetailPage({ scenarioId, onClose }: ScenarioDetailPageProps) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-background border-b sticky top-0 z-10">
        <div className="container mx-auto max-w-7xl px-3 sm:px-6 py-2">
          <Button
            variant="ghost"
            onClick={onClose}
            className="flex items-center gap-1 sm:gap-1.5 hover:bg-accent h-9 sm:h-10 px-2 sm:px-3 touch-manipulation text-xs sm:text-sm"
          >
      ...
      {/* メインコンテンツ */}
      <div className="container mx-auto max-w-7xl px-3 sm:px-6 py-3 sm:py-6">
