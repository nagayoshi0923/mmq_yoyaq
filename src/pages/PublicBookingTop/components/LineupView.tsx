  ...
  return (
    <div className="space-y-6 md:space-y-8">
      ...
      {displayedNewScenarios.length > 0 && (
        <section>
          <h2 className="text-lg md:text-base xl:text-lg mb-3 md:mb-4 flex items-center gap-2 leading-tight">
            <span>新着公演</span>
      ...
      {displayedUpcomingScenarios.length > 0 && (
        <section>
          <h2 className="text-lg md:text-base xl:text-lg mb-3 md:mb-4 leading-tight">
            直近公演
