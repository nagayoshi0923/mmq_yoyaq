  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-purple-800 text-white">
        <div className="container mx-auto max-w-7xl px-2 xs:px-2 sm:px-2 md:px-4 lg:px-6 xl:px-8 2xl:px-8 py-5 xs:py-6 sm:py-10 md:py-12">
      ...
      <div className="bg-white border-b sticky top-0 z-10 shadow-sm">
        <div className="container mx-auto max-w-7xl px-2 xs:px-2 sm:px-2 md:px-4 lg:px-6 xl:px-8 2xl:px-8 py-1.5 xs:py-2 sm:py-3">
      ...
      <div className="container mx-auto max-w-7xl px-2 xs:px-2 sm:px-2 md:px-4 lg:px-6 xl:px-8 2xl:px-8 py-2.5 xs:py-3 sm:py-4 md:py-6">
        ...
        <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
            <TabsList className="grid w-full grid-cols-3 mb-2.5 xs:mb-3 sm:mb-6 h-8 xs:h-9 sm:h-10 md:h-11 gap-1 xs:gap-1 sm:gap-0">
              ...
              <TabsTrigger value="list" className="text-xs px-1 xs:px-2 sm:px-3">リスト</TabsTrigger>
            </TabsList>
