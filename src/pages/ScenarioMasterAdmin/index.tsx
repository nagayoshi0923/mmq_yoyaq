...
import type { ScenarioMaster } from './scenarioMasterAdmin/types'
import { STATUS_CONFIG } from './scenarioMasterAdmin/types'
import { buildScenarioMasterColumns } from './scenarioMasterAdmin/scenarioMasterColumns'
import {
...
export function ScenarioMasterAdmin() {
  ...
  const tableColumns: Column<ScenarioMaster>[] = useMemo(
    () => buildScenarioMasterColumns({ filteredMasters, selectedIds, setSelectedIds, handleEdit, handleStatusChange }),
