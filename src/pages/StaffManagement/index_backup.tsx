...
// ユーティリティ
import { formatStaffAvailability, getAvailabilityBadgeVariant, getStatusBadge, getRoleBadges, getStoreColors } from './utils/staffFormatters'
import { 
  Users, 
  Plus, 
  Edit, 
...
export function StaffManagement() {
  ...
  // utils/staffFormatters.tsx から import した関数を使用
