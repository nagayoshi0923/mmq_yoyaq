    ...
    <div className="space-y-6 max-w-4xl mx-auto pb-12">
      ...
      <section className="bg-white rounded-xl border p-6">
        <SectionTitle
          icon={Coins}
          label="報酬計算方式"
          description="時間別テーブル方式か計算式方式かを選択します。公演時間に応じた報酬の計算方法が変わります。"
        />
      ...
      <section className="bg-white rounded-xl border p-6">
        <SectionTitle
          icon={Users}
          label="GM報酬"
          description={formData.use_hourly_table
            ? 'メインGMへの公演時間ごとの報酬額を設定します。スケジュール管理の報酬計算に使用されます。'
            : 'メインGMの基本給・時給を設定します（計算式: 基本給 + 時給 × 公演時間）。スケジュール管理の報酬計算に使用されます。'}
        />
      ...
      <section className="bg-white rounded-xl border p-6">
        <SectionTitle
          ...
          label="GMテスト報酬"
          description={formData.use_hourly_table
            ? 'GMテスト公演時の報酬額を設定します（通常は通常公演より低め）。'
            : 'GMテスト公演時の報酬を設定します（計算式: 基本給 + 時給 × 公演時間。通常は基本給なし）。'}
        />
        <div className="space-y-4">
          {formData.use_hourly_table ? (
            // 時間別テーブル方式
      ...
      <section className="bg-white rounded-xl border p-6">
        <SectionTitle
          icon={Calculator}
          label="受付報酬"
          description="受付スタッフへの固定報酬を設定します。公演時間に関係なく一定額が支払われます。"
        />
        <div className="space-y-2">
