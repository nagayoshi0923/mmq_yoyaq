        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4 p-4 bg-gray-100 rounded-lg">
            <div className="flex items-center gap-2">
              ...
              <h4 className="font-medium text-gray-800">予約キャンセル時</h4>
            </div>
            <div className="space-y-3">
              <div className="space-y-2">
                <Label htmlFor="system_msg_booking_cancelled_title">タイトル</Label>
                <Input
                  id="system_msg_booking_cancelled_title"
                  value={formData.system_msg_booking_cancelled_title}
                  onChange={(e) => setFormData(prev => ({ ...prev, system_msg_booking_cancelled_title: e.target.value }))}
                  placeholder="ご予約がキャンセルされました"
                />
              </div>
              <div className="space-y-2">
                <Label htmlFor="system_msg_booking_cancelled_body">本文</Label>
                <Textarea
                  id="system_msg_booking_cancelled_body"
                  value={formData.system_msg_booking_cancelled_body}
