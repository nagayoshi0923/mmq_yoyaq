        ...
        <CardContent className="p-3 sm:p-4 md:pt-6">
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <div className="min-w-0">
              <p className="text-lg sm:text-base md:text-lg">{stats.totalScenarios}</p>
      ...
      <Card>
        <CardContent className="p-3 sm:p-4 md:pt-6">
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <div className="min-w-0">
              <p className="text-lg sm:text-base md:text-lg">{stats.availableScenarios}</p>
      ...
      <Card>
        <CardContent className="p-3 sm:p-4 md:pt-6">
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <div className="min-w-0">
              <p className="text-lg sm:text-base md:text-lg">¥{stats.totalLicenseAmount.toLocaleString()}</p>
      ...
      <Card>
        <CardContent className="p-3 sm:p-4 md:pt-6">
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <div className="min-w-0">
              <p className="text-lg sm:text-base md:text-lg">{stats.avgPlayers}名</p>
