...
export const SITE_OVERVIEW_DEFAULT: HardcodedPageContent = {
  ...
  sections: [
    // ─── 1. サインアップ・ログイン ──────────────────────────────────
    {
      ...
      intro: "アカウントを作って組織管理画面にアクセスするまでの流れです。",
      items: [
        {
          title: "招待を受け取る",
          body: "MMQ 運営または既存の組織管理者から、招待リンクがメールで届きます。リンクの有効期限は 7 日間です。",
        },
        {
          title: "アカウント作成（メール認証）",
          body: "招待リンクからメールアドレス・パスワードを設定。確認メールが届くので URL をクリックして認証してください。",
          orderedBullets: [
            "「メールアドレスの確認」メールが届く",
            "本文中のリンクをクリック",
            "プロフィール入力（氏名・電話番号）に進む",
          ],
        },
        {
          title: "ログイン後の画面",
          body: "ログイン直後は「ダッシュボード」が表示されます。所属組織が 1 つなら自動で選択され、複数あれば組織選択画面が出ます。",
          note: "ヒント: パスワードを忘れた場合はログイン画面の「パスワードリセット」から再設定メールを送信できます",
          noteType: "info",
        },
      ],
    },
    ...
    // ─── 2. サイドバーの見方 ──────────────────────────────────────
    {
      ...
      items: [
        ...
        {
          title: "マニュアル",
          body: "「共通」「運営」の 2 系統に分かれた業務マニュアル。本ページもここから開けます。",
        },
        {
          title: "設定",
          body: "組織情報・店舗情報・通知設定・メール設定・チャット設定など、運営の前提となる設定を集約。",
          note: "設定変更は反映に数秒〜数分かかることがあります",
          noteType: "info",
        },
      ],
    },
