  ...
  return (
    <div className="border rounded-lg p-4 bg-white max-h-[500px] overflow-y-auto">
      ...
      <div className="bg-gray-50 rounded-lg p-3 mb-3">
        <h3 className="text-gray-700 font-semibold mb-2 text-sm">■ 概要</h3>
        <table className="w-full text-sm">
          <tbody>
            <tr>
              <td className="py-1 font-medium text-gray-700">総公演数</td>
              <td className="py-1 text-gray-900 text-right">{author.totalEvents}回</td>
            </tr>
            <tr>
              <td className="py-1 font-medium text-gray-700">総ライセンス料</td>
              <td className="py-1 text-gray-900 text-right text-base font-bold">
      ...
      <div className="bg-gray-50 rounded-lg p-3 mb-3">
        <h3 className="text-gray-700 font-semibold mb-2 text-sm">■ 詳細</h3>
          ...
          {author.scenarios.map((scenario, index) => {
            ...
            return (
              <div key={index} className="text-sm text-gray-700 border-b border-gray-200 pb-2 last:border-0">
                <div className="font-medium">{scenario.title}{gmTestLabel}</div>
      ...
      <div className="bg-blue-50 border-l-4 border-blue-600 rounded p-3 mb-3">
        <h3 className="text-blue-900 font-semibold mb-1 text-sm">■ お支払いについて</h3>
