    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto max-w-7xl px-[10px] py-2.5 xs:py-3 sm:py-4 md:py-6">
        <div className="space-y-2.5 xs:space-y-3 sm:space-y-4 md:space-y-6">
          {/* 概要統計 */}
          <section>
            <h2 className="text-base xs:text-lg sm:text-base md:text-lg leading-tight">概要</h2>
            <div className="grid grid-cols-2 gap-2 xs:gap-2.5 sm:gap-3 md:gap-4 mt-2 xs:mt-3 sm:mt-4">
              <Card>
                ...
                <CardContent className="p-2 xs:p-3 sm:p-4 md:p-6 pt-1">
                  <div className="text-lg xs:text-base sm:text-lg md:text-lg">{stats.stores}</div>
              ...
              <Card>
                ...
                <CardContent className="p-2 xs:p-3 sm:p-4 md:p-6 pt-1">
                  <div className="text-lg xs:text-base sm:text-lg md:text-lg">{stats.performances}</div>
              ...
              <Card>
                ...
                <CardContent className="p-2 xs:p-3 sm:p-4 md:p-6 pt-1">
                  <div className="text-lg xs:text-base sm:text-lg md:text-lg">{stats.reservations}</div>
              ...
              <Card>
                ...
                <CardContent className="p-2 xs:p-3 sm:p-4 md:p-6 pt-1">
                  <div className="text-lg xs:text-base sm:text-lg md:text-lg">
