  ...
  return (
    <div className="space-y-3">
      ...
      <div className="rounded-lg border bg-slate-50/70 p-3 space-y-2">
          ...
          <div className="flex items-center gap-2 flex-1">
            ...
            <div className="relative w-24">
              <Input id="weekend_duration" type="number" min="30" max="480"
                ...
                placeholder="同じ" className="h-7 text-xs pr-8" />
              <span className="absolute right-2 top-1/2 -translate-y-1/2 text-xs text-muted-foreground">分</span>
            </div>
        ...
        {/* 追加準備時間 */}
        <div className="flex items-center gap-3">
          <span className="text-xs text-muted-foreground w-[80px] shrink-0 text-right">追加準備時間</span>
          <div className="relative w-24">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <Input id="player_count_min" type="number" min="1" max="20"
            ...
            <Input id="player_count_max" type="number" min="1" max="20"
      ...
      <div className="rounded-lg border bg-slate-50/70 p-3 space-y-2">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-[11px] text-muted-foreground">「準備中」は予約不可</span>
        </div>
      </div>
