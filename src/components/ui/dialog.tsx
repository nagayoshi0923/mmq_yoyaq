...
>(({ className, children, size = 'md', ...props }, ref) => {
  ...
  const sizeClasses = {
    ...
    md: 'max-w-[95vw] sm:max-w-2xl max-h-[90vh] sm:max-h-[min(600px,85vh)]',
    lg: 'max-w-[95vw] sm:max-w-4xl max-h-[90vh] sm:max-h-[min(700px,85vh)]',
