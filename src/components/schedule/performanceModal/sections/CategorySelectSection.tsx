/**
 * 公演モーダル カテゴリ（クイック選択）（PerformanceModal から子コンポーネント抽出・挙動不変）。
 * 主要カテゴリのピル＋「その他」セレクト＋カスタム種別名入力。
 * JSX は元 PerformanceModal の IIFE ブロックを逐語移植し、クロージャ参照を同名 props 化しただけ。
 */
...
export function CategorySelectSection({ formData, setFormData }: CategorySelectSectionProps) {
