...
export const SETTINGS_PAGES: SettingsPageDefinition[] = [
  ...
  { id: 'cancellation-billing', label: 'キャンセル料の請求', scope: 'organization', description: '振込先・請求・照合の設定', effect: 'キャンセル料請求の設定です。予約時の規定は組織共通を基本に、店舗・シナリオ・公演で個別指定できます。', related: ['cancellation'] },
  ...
  { id: 'operations-common', label: '開催判断・準備・クーポン・事前配役アンケート', scope: 'organization', description: '組織共通の判断時刻・準備時間・クーポン利用・アンケート設定', effect: '店舗・シナリオ・公演で個別指定できます。', related: ['store-operations'] },
  { id: 'store-operations', label: '開催判断・準備・クーポン・事前配役アンケート', scope: 'store', description: '店舗での個別指定', effect: '組織共通を継承し、シナリオ・公演の指定があれば優先します。', related: ['operations-common'] },
  { id: 'payment-common', label: '支払い方法の案内', scope: 'organization', description: '予約時に表示する組織共通の案内', effect: '店舗・シナリオ・公演で個別指定した項目以外に適用します。', related: ['reservation'] },
  { id: 'reservation', label: '支払い方法の案内', scope: 'store', description: '予約時に表示する支払い方法', effect: '組織共通の案内を使うか、この店舗で個別指定します。シナリオ・公演の指定があれば優先します。', related: ['private-booking', 'cancellation', 'email'] },
  ...
  { id: 'cancellation', label: 'キャンセル・変更', scope: 'store', description: '通常・貸切の規定、期限、料金・返金案内', effect: '組織共通の規定を使うか、この店舗で個別指定します。シナリオ・公演の指定を優先し、予約済みの条件は維持します。', related: ['cancellation-billing', 'booking-notice'] },
