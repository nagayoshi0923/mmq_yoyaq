...
export const SETTINGS_PAGES: SettingsPageDefinition[] = [
  ...
  { id: 'operations-common', label: '開催判断・準備・事前配役アンケート', scope: 'organization', description: '組織共通の判断時刻・準備時間・アンケート設定', effect: '店舗・シナリオ・公演で個別指定できます。', related: ['store-operations'] },
  { id: 'store-operations', label: '開催判断・準備・事前配役アンケート', scope: 'store', description: '店舗での個別指定', effect: '組織共通を継承し、シナリオ・公演の指定があれば優先します。', related: ['operations-common'] },
