 ...
 * 
 * 実行方法:
 * 1. Supabase Dashboard > Project Settings > API から Service Role Key を取得
 * 2. 以下のコマンドを実行:
 *    SUPABASE_URL=https://xxx.supabase.co SUPABASE_SERVICE_ROLE_KEY=xxx npx ts-node scripts/set-initial-passwords.ts
 */
...
if (!SUPABASE_URL || !SUPABASE_SERVICE_ROLE_KEY) {
  ...
  console.log('使用方法:')
  console.log('SUPABASE_URL=xxx SUPABASE_SERVICE_ROLE_KEY=xxx npx ts-node scripts/set-initial-passwords.ts')
  process.exit(1)
}
