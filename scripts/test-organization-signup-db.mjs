...
CREATE TABLE customers(user_id uuid,organization_id uuid,name text,email text,phone text,prefecture text,birth_date date,visit_count int,total_spent int,notification_settings jsonb,created_at timestamptz,updated_at timestamptz);
